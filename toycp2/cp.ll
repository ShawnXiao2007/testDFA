...
entry:
  ...
  store i32 %call7, i32* %fd1, align 4
  ...
  %call14 = call i64 @write(i32 %20, i8* %21, i64 16)
  %22 = load i32* %fd2, align 4
  %23 = load i8** %p2, align 8
  %call15 = call i64 @write(i32 %22, i8* %23, i64 16)
  %24 = load i32* %fs1, align 4
  %call16 = call i32 @close(i32 %24)
  %25 = load i32* %fs2, align 4
  %call17 = call i32 @close(i32 %25)
  %26 = load i32* %fd1, align 4
  %call18 = call i32 @close(i32 %26)
  %27 = load i32* %fd2, align 4
  %call19 = call i32 @close(i32 %27)
  ret i32 0
}
